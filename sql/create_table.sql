...
-- 初始化数据
-- 密码是 12345678（MD5 加密 + 盐值 lyu）
INSERT INTO user (id, userAccount, userPassword, userName, userAvatar, userProfile, userRole) VALUES
(1, 'admin', '128ad30673b77ca516689c0ea0f00638', 'Administrator', '', 'System administrator', 'admin'),
(2, 'user', '128ad30673b77ca516689c0ea0f00638', 'Regular User', '', 'I am a regular user', 'user'),
(3, 'test', '128ad30673b77ca516689c0ea0f00638', 'Test Account', '', 'This is a test account', 'user');
